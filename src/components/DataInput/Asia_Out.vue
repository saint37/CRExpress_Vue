                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="整车" prop="totalLoad">  
                            <el-input v-model.number="editForm.totalLoad" auto-complete="off"></el-input>  
                        </el-form-item> 
                    </el-col>
                </el-row> 
                <el-row>
  ...
  data () {
    return {
        ...
        editFormRules: {  
            ...
            exitportStation: [  
                { required: true, message: '请输入出境口岸站', trigger: 'blur' },
                { pattern: /^[\u4E00-\u9FA5\(（\)）]{2,8}$/, message: '请输入2-6个中文', trigger:'change'+'blur' }
            ],
            overseasStation: [  
                { required: true, message: '请输入境外到站', trigger: 'blur' },
                { pattern: /^[\u4E00-\u9FA5A-Za-z]{2,15}$/, message: '请输入2-15位中文或英文', trigger:'change'+'blur' }
            ],
            overseasCountry: [  
                { required: true, message: '请输入境外到站所属国', trigger: 'blur' },
                { pattern: /^[\u4E00-\u9FA5A-Za-z]{2,10}$/, message: '请输入2-10位中文或英文', trigger:'change'+'blur' }
            ],
            overseasCity: [  
                { required: true, message: '请输入境外到站所属城市', trigger: 'blur' },
                { pattern: /^[\u4E00-\u9FA5A-Za-z]{2,15}$/, message: '请输入2-15位中文或英文', trigger:'change'+'blur' }
            ],
            trainQty: [  
